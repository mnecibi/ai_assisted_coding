...
### Tiny example — HTTP MCP server pointed at Spring Boot Actuator
...
- **Discoverability** — the server advertises exactly which tools exist; the model doesn't have to guess endpoint paths.
...
- [MCP server registry](https://github.com/modelcontextprotocol/servers) — official servers including postgres, github, slack, brave-search
